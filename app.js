...
//  let Student.prototype.greeting = () => {
//     return `Hi, my name is ${this.name}`;
// };
// TODO: Uncomment the following line of code to see the output in the browser console
...
// - When "this" is invoked in joe.scope() is calls the name from the new Student constructor

// 2. What is "this" when joe.scopeArrow() is invoked?
// - Im guessing "this" in this invoke it shows a list of functions

// 3. Explain why "this" is different when an arrow function is used.
// - It calls the constructor function without needing the '.' behind 'this' 